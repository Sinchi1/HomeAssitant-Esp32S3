...
# План разработки проекта мониторинга микроклимата
...
Построение структуры проекта, настройка окружения, установка всех нужных зависимостей. 
Разработка программного модуля для подключения к термометрам и иным элементам сбора информации.
Разработка программного модуля для сбора/агрегации данных с устройств.
Создания UI интерфейса на плате.
Отладка систем проекта. 
